...
/*
	...
	Initial file was taken from the second try this assignment in Chaper 6.

	09/14/2021: Modified to include all of the requirements listed in Chapter 7. These include:
	- Recovering from errors
	- Symbolic Constants
	- Negative numbers
	- % added to operations
	- Dividing Main into 2 sperate functions
...
Token Token_stream::get()
{
    ...
    default:
		if (isalpha(ch)) {
			string s;
			s += ch;
			while (cin.get(ch) && (isalpha(ch) || isdigit(ch))) s += ch; // cin.get reads one character at a time, test that part of the name and concates it to string s
