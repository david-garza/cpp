...
/*
	...
	- For exercise 07.09, I need to recommend 3 improvements for the calculator, but only implement 1
		- Error catch when user attempts to name a variable or constant as a reserved work
	...
	11/7/2021
	- Added listing of variable table to help menu
	- removed capital H from global constants
	- Made Expression, Term, and Primary take Token_Stream as a parameter
...
void help() {
	...
	cout << "\tDeclare constant: " << constkey << " g = -9.81" << endl;
	cout << "\tPrint variable table: " << listkey << endl << endl;
