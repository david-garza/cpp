// Excercise 3.4, the requirement is to read in two integers and then perform the following operations on them
...
int main() {
	...
	cout << "Plese enter two integer values seperated by a space, then press enter: ";
	cin >> val1 >> val2;
